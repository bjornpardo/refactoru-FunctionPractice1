...
// Write a function called 'tripleFive' which loops 
// three times using a for loop. Each iteration of the loop, 
...
// Write a function called 'lastLetter' which takes a 
// single string argument and returns the last character in the string.
...
// Write a function called 'sun' which takes a single string argument 
// and returns true if the string contains the word 'sun' within it. 
// You may use the indexOf method that is built-in to strings, 
// or you can do it manually with a for loop.
...
// Write a function called 'tiny' which takes a single number argument 
...
// Write a function called 'getSeconds' which takes a single 
// string argument in the format 'MM:SS' (hours, minutes, and seconds) 
